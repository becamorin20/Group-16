...
if __name__ == "__main__":
    ...
    for iteration in range(5):
        ...
        plt.title( "Handode" )
        plt.savefig("/Users/edisonweik/Desktop/cs175/maze_plots/baseline-handcode/maze_handcode" + str(iteration) + ".pdf")
        plt.close()
    ...
    plt.xlabel( "Episodes" )
    plt.ylabel( "Time Steps" )
    plt.title( "Handcode - Total" )
    plt.savefig("/Users/edisonweik/Desktop/cs175/maze_plots/baseline-handcode/maze_hancode_total.pdf")

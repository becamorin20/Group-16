...
# Edison Weik
#
# q_approximation_tile.py
#
# Implements Q-learning algorithm with function approximation, 9 tile stationary circular
...
def a1( agent ):
    ...
    x = agent[0]
    z = agent[1]
    return 1 if ( -3.5<x<-0.5 and 1.5<z<4.5 ) else 0
    
def a2( agent ):
    ''' Tile in top center '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -7.5<=x<=-3.5 and 1.5<z<4.5 ) else 0
    
def a3( agent ):
    ''' Tile in top right '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -10.5<x<-7.5 and 1.5<z<4.5 ) else 0

def a4( agent ):
    ''' Tile in middle left '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -3.5<x<-0.5 and -2.5<=z<=1.5 ) else 0
    
def a5( agent ):
    ''' Tile in middle center '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -7.5<=x<=-3.5 and -2.5<=z<=1.5 ) else 0

def a6( agent ):
    ''' Tile in middle right '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -10.5<x<-7.5 and -2.5<=z<=1.5 ) else 0

def a7( agent ):
    ''' Tile in botttom left '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -3.5<x<-0.5 and -5.5<z<-2.5 ) else 0
    
def a8( agent ):
    ''' Tile in bottom center '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -7.5<=x<=-3.5 and -5.5<z<-2.5 ) else 0
    
def a9( agent ):
    ''' Tile in bottom right '''
    x = agent[0]
    z = agent[1]
    return 1 if ( -10.5<x<-7.5 and -5.5<z<-2.5 ) else 0

...
# Edison Weik
#
# q_approximation_coarse3.py
#
# Implements Q-learning algorithm with function approximation, 25 coarse stationary circular
...
def a1( agent ):
    ''' Circle with center (-1.5,3.5) and radius 1.4142 = square root of 2 '''
    x = agent[0]
    z = agent[1]
    return 1 if (-1.5-x)**2 + (3.5-z)**2 < 2.0 else 0
    
def a2( agent ):
    ''' Circle with center (-3.5,3.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-3.5-x)**2 + (3.5-z)**2 < 2.0 else 0
    
def a3( agent ):
    ''' Circle with center (-5.5,3.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-5.5-x)**2 + (3.5-z)**2 < 2.0 else 0

def a4( agent ):
    ''' Circle with center (-7.5,3.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-7.5-x)**2 + (3.5-z)**2 < 2.0 else 0
    
def a5( agent ):
    ''' Circle with center (-9.5,3.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-9.5-x)**2 + (3.5-z)**2 < 2.0 else 0

def a6( agent ):
    ''' Circle with center (-1.5,1.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-1.5-x)**2 + (1.5-z)**2 < 2.0 else 0

def a7( agent ):
    ''' Circle with center (-3.5,1.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-3.5-x)**2 + (1.5-z)**2 < 2.0 else 0  
    
def a8( agent ):
    ''' Circle with center (-5.5,1.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-5.5-x)**2 + (1.5-z)**2 < 2.0 else 0   
    
def a9( agent ):
    ''' Circle with center (-7.5,1.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-7.5-x)**2 + (1.5-z)**2 < 2.0 else 0 

def a10( agent ):
    ''' Circle with center (-9.5,1.5) and radius root(2.0) '''
    x = agent[0]
    z = agent[1]
    return 1 if (-9.5-x)**2 + (1.5-z)**2 < 2.0 else 0
    
def a11( agent ):
    ''' Circle with center (-1.5,-0.5) and radius root(2.0) '''
    x = agent[0]
    z = agent[1]
    return 1 if (-1.5-x)**2 + (-0.5-z)**2 < 2.0 else 0
    
def a12( agent ):
    ''' Circle with center (-3.5,-0.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-3.5-x)**2 + (-0.5-z)**2 < 2.0 else 0
    
def a13( agent ):
    ''' Circle with center (-5.5,-0.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-5.5-x)**2 + (-0.5-z)**2 < 2.0 else 0

def a14( agent ):
    ''' Circle with center (-7.5,-0.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-7.5-x)**2 + (-.5-z)**2 < 2.0 else 0
    
def a15( agent ):
    ''' Circle with center (-9.5,-0.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-9.5-x)**2 + (-.5-z)**2 < 2.0 else 0

def a16( agent ):
    ''' Circle with center (-1.5,-2.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-1.5-x)**2 + (-2.5-z)**2 < 2.0 else 0

def a17( agent ):
    ''' Circle with center (-3.5,-2.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-3.5-x)**2 + (-2.5-z)**2 < 2.0 else 0  
    
def a18( agent ):
    ''' Circle with center (-5.5,-2.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-5.5-x)**2 + (-2.5-z)**2 < 2.0 else 0   
    
def a19( agent ):
    ''' Circle with center (-7.5,-2.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-7.5-x)**2 + (-2.5-z)**2 < 2.0 else 0 

def a20( agent ):
    ''' Circle with center (-9.5,-2.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-9.5-x)**2 + (-2.5-z)**2 < 2.0 else 0

def a21( agent ):
    ''' Circle with center (-1.5,-4.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-1.5-x)**2 + (-4.5-z)**2 < 2.0 else 0
    
def a22( agent ):
    ''' Circle with center (-3.5,-4.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-3.5-x)**2 + (-4.5-z)**2 < 2.0 else 0
    
def a23( agent ):
    ''' Circle with center (-5.5,-4.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-5.5-x)**2 + (-4.5-z)**2 < 2.0 else 0

def a24( agent ):
    ''' Circle with center (-7.5,-4.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-7.5-x)**2 + (-4.5-z)**2 < 2.0 else 0
    
def a25( agent ):
    ''' Circle with center (-9.5,-4.5) and radius root(2.0)'''
    x = agent[0]
    z = agent[1]
    return 1 if (-9.5-x)**2 + (-4.5-z)**2 < 2.0 else 0

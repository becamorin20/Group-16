...
This is too large a number for us to expect to keep track of, so we approximate this table with a list of parameters <img src="https://github.com/becamorin20/Group-16/blob/master/docs/images/theta.png" width="25">

...
# zombie_maze.py
#
# Implements Minecraft environment WITH NO MAZE and zombies.
...
if __name__ == "__main__":
    ...
    plt.title( "No Maze - Q-Approximation No Stationary Basis - 100 Episodes" )
    #plt.show()
    plt.savefig("/Users/edisonweik/Desktop/cs175/no_maze_q_no_stationary_basis_100.pdf")

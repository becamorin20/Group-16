...
if __name__ == "__main__":
    ...
    for iRepeat in range(100):
        ...
        print "Alive for " + str(total_commands) + " commands, reward = " + str(total_reward)
        while world_state.is_mission_running:
            world_state = agent_host.getWorldState()
            pass
        time.sleep(1)
    ...
    plt.title( "Maze - Random - 100 Episodes" )
    #plt.show()
    plt.savefig("/Users/edisonweik/Desktop/cs175/maze_random_100.pdf")
